...
export async function* streamReviewerAssist(
  ...
  if (!apiKey || !base) {
    yield 'AI Reviewer Assist requires Azure OpenAI configuration. Set VITE_AZURE_OPENAI_KEY and VITE_AZURE_OPENAI_ENDPOINT in .env.local to enable this feature.'
    return
  }
